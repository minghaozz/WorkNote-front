...
class AddLife extends Component {
    ...
    render() {
        ...
        const addLife = <Form {...formItemLayout} onSubmit={this.handleSubmit}>
            <Form.Item label="标题" >
        ...
        return (
            <Main data={addLife}></Main>
        );
    }
}

const WrappedAddLife = Form.create({name: 'addWork'})(AddLife);

export default connect(state => ({}), {})(WrappedAddLife);
